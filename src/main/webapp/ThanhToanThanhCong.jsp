...
<body>
 ...
 %> <span class="cart-number"></span>
		...
		<hr>
		<br>
		<h1 style="color: #4caf50;" align="center">Thanh toán thành công</h1>
		<br>
		<p align="center">Thời gian: <%=df.format(Calendar.getInstance().getTime())%><p>
		...
		<div class="content" style="margin-top: 0 !important;">
			<table class="listSanPham">
				<tbody>
					...
					%>
					<tr style="font-weight: bold; text-align: center;height: 48px;">
					...
					Cookie cookie = new Cookie("cart", URLEncoder.encode(gson.toJson(new CART()), "UTF-8"));
					cookie.setPath("/");
